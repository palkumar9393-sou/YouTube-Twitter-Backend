...
1. **Clone the repository:**
    ...
    ```bash
   https://github.com/palkumar9393-sou/YouTube-Twitter-Backend.git
    ```
...
3. **Set up environment variables:**
    Create a .env in root of project and fill in the required values in the .env file using .env.sample file file
